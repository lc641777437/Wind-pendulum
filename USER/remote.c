...
void key_scan()
{
	  key=Remote_Scan();	
		...
		{	 
			switch(key)
			{
				case 0:str_temp='!';break;			   
				case 162:str_temp='O';break;	    
				case 226:str_temp='M';break;	    
				case 34:str_temp='T';break;		 
				case 2:str_temp='+';break;		  
				case 194:str_temp='D';break;	   
				case 224:str_temp='L';break;		  
				case 168:str_temp='P';break;		  
				case 144:str_temp='R';break;		   
				case 104:str_temp='0';break;		    
				case 152:str_temp='-';break;		  	   
				case 176:str_temp='A';break;	    
				case 48:str_temp='1';break;		    
				case 24:str_temp='2';break;		    
				case 122:str_temp='3';break;		  
				case 16:str_temp='4';break;			   					
				case 56:str_temp='5';break;	 
				case 90:str_temp='6';break;
				case 66:str_temp='7';break;
				case 74:str_temp='8';break;
				case 82:str_temp='9';break;
        default : str_temp='e';				
			}
			delay_ms(20);
			if((str_temp>='0'&&str_temp<='9')||str_temp=='.')
			{ 		
		 	  str[str_i]=str_temp;
				str_i++;	
				ShowQQChar(0x90,str,strlen(str)%2==0?strlen(str)/2:strlen(str)/2+1);
			}
			else if(str_temp=='P')
			{
				str_i=0;
